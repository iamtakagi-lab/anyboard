export default {
    ...
    BASE_URL: process.env.BASE_URL ? process.env.BASE_URL : 'https://anyboard.iamtakagi.net/',
    API_BASE_URL: process.env.API_BASE_URL ? process.env.API_BASE_URL : 'https://anyboard.iamtakagi.net/api',
